...
{:else}
	<FieldContainer>
		<!--p24.s.before: Anything you want before the core field elements. -->
		<slot name="before" />
		...
		{/if}
		<!--p24.s.after: Anything you want after the core field elements. -->
		<slot name="after" />
	</FieldContainer>
{/if}
